...
db.version(8).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
...
db.version(9).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar, deskRow, deskCol',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
...
db.version(10).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar, deskRow, deskCol, unlockedAvatars, spentCoins',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
...
db.version(11).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar, deskRow, deskCol, unlockedAvatars, spentCoins, lastVisitDate, bonusCoins',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
...
db.version(12).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar, deskRow, deskCol, unlockedAvatars, spentCoins, lastVisitDate, bonusCoins, boardMessage',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
...
db.version(13).stores({
  ...
  subjects:   '++id, name, color',
  exams:      '++id, date, subject, range',
  characters: '++id, nickname, job, coin, avatar, deskRow, deskCol, unlockedAvatars, spentCoins, lastVisitDate, bonusCoins, boardMessage, themeBg, themeAccent, unlockedThemes',
  quests:     '++id, title, subject, difficulty, coin, status, date, actualDuration',
});
