...
const STATUS_BADGE = {
  ...
  completed: { label: '완료',   cls: 'text-green-600 bg-green-50' },
};
      ...
      {status === 'pending' && (
        <>
          <button
            ...
            className="w-full min-h-[44px] rounded-xl bg-amber-400 text-white font-medium hover:bg-amber-500 transition-colors mb-2"
          >
            ▶ 학습중
          </button>
          <button
      ...
      {status === 'studying' && (
        <>
          ...
          <button
            ...
            className="w-full min-h-[44px] rounded-xl bg-gray-100 text-gray-600 font-medium hover:bg-gray-200 transition-colors mb-2"
          >
            ↩ 미완료로
          </button>
        </>
